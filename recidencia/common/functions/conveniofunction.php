...
// =======================================================
// [S1] SECCION 1: Funciones generales (helpers, formatos)
// =======================================================
...
if (!function_exists('convenioHydrateFormDataFromRecord')) {
    /**
     * @param array<string, mixed> $convenio
     * @return array<string, string>
     */
    function convenioHydrateFormDataFromRecord(array $convenio): array
    {
        $data = convenioFormDefaults();

        $data['empresa_id'] = isset($convenio['empresa_id']) ? (string) $convenio['empresa_id'] : '';
        $data['folio'] = isset($convenio['folio']) && $convenio['folio'] !== null
            ? trim((string) $convenio['folio'])
            : '';
        ...
        $data['fecha_inicio'] = isset($convenio['fecha_inicio']) && $convenio['fecha_inicio'] !== null
            ...
            : '';
        $data['fecha_fin'] = isset($convenio['fecha_fin']) && $convenio['fecha_fin'] !== null
            ? trim((string) $convenio['fecha_fin'])
            : '';
        $data['observaciones'] = isset($convenio['observaciones']) && $convenio['observaciones'] !== null
...
// =======================================================
// [S2] SECCION 2: Funciones para ADD
// =======================================================
...
// =======================================================
// [S3] SECCION 3: Funciones para EDIT
// =======================================================
...
// =======================================================
// [S4] SECCION 4: Funciones para LIST
// =======================================================
