...
<head>
  ...
  <style>
    ...
    .status-strip{display:flex;align-items:center;gap:10px;padding:10px 12px;border:1px solid #bbf7d0;background:#ecfdf5;border-radius:12px;margin-bottom:10px}
    .status-strip .big {font-weight:800;color:#166534}
    .readonly-note{color:#475569;font-size:13px}
  </style>
</head>
<body>
