    ...
    <main class="dashboard-main">
      ...
      <section class="kpi-row">
        ...
        <article class="kpi-card teal">
          ...
          <div class="kpi-sub">Comentarios: <?php echo htmlspecialchars((string)$kpiMachote['comentariosPendientes']); ?></div>
        ...
        <article class="kpi-card amber">
          ...
          <div class="kpi-value">
            <?php echo htmlspecialchars((string)$kpiDocs['aprobados']); ?>/<?php echo htmlspecialchars((string)$kpiDocs['total']); ?> aprobados
          </div>
          ...
          <div class="kpi-sub">
            Pendientes: <?php echo htmlspecialchars((string)$kpiDocs['pendientes']); ?> · Avance: <?php echo $docsPercent; ?>%
          </div>
        </article>
        ...
        <article class="kpi-card pink">
          ...
          <div class="kpi-sub">Activos: <?php echo htmlspecialchars((string)$kpiEstudiantes['activos']); ?></div>
          <div class="kpi-sub">Sin asignar: <?php echo htmlspecialchars((string)$kpiEstudiantes['sinAsignar']); ?></div>
        </article>
