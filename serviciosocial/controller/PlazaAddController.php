...
require_once __DIR__ . '/../model/PlazaAddModel.php';
require_once __DIR__ . '/../../common/model/db.php';

use Common\Model\Database;
use InvalidArgumentException;
use PDO;
use Serviciosocial\Model\PlazaAddModel;

class PlazaAddController
{
    private PlazaAddModel $plazaModel;
    ...
    public function __construct(?PDO $pdo = null)
    {
        ...
        $this->plazaModel = new PlazaAddModel($pdo);
    }
