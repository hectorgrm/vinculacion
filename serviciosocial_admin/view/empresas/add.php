...
<head>
  ...
  <link rel="stylesheet" href="../../assets/css/empresa/empresaadd.css">
        ...
        <div class="content">
          <form>
            ...
            <div class="full">
              ...
              <input type="text" id="direccion" placeholder="Ej: Calle Reforma #123, Guadalajara, Jalisco" />
            </div>

            <div class="full">
              <label for="descripcion">Descripción / Giro</label>
              <input type="text" id="descripcion" placeholder="Ej: Asociación civil enfocada al desarrollo comunitario" />
            </div>
          </form>
        </div>
      </section>
